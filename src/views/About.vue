...
<template>
  <main class="relative px-4 py-12 sm:px-6 lg:px-8">
      <div class="text-lg max-w-prose mx-auto">
        <h1 class="mt-2 block text-3xl text-center leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Qui est Josépha ?</h1>
      </div>
