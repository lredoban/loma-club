<template>
  <div class="relative bg-creme">
    <main ref="target" class="transition duration-300 lg:relative">
      <div class="mx-auto max-w-7xl w-full pt-16 pb-10 text-center lg:py-36 lg:text-left xl:py-48">
        <div class="px-4 lg:w-1/2 sm:px-8 xl:pr-16">
          <h1 class="text-2xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-4xl lg:text-3xl xl:text-4xl">
            <span class="block xl:inline">Aussi appelé armée pacifique, le <span class="block text-ocre xl:inline">Loma Club</span>, est un club de parole privé autour de la maternité.</span>
      ...
      <div class="relative w-full p-6 grid grid-cols-3 grid-rows-3 sm:h-72 md:h-[48rem] lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 lg:h-full">
        <img src="../assets/img/hero-illu/Mamaleft.svg" alt="Maman allaitant pendant une visio" class="row-start-2" :style="styleMamaLeft"/>
        <img src="../assets/img/hero-illu/Mamatop.svg" alt="Maman croisant les bras pendant une visio" class="col-start-2" :style="styleMamaTop"/>
        <img src="../assets/img/hero-illu/Mamaright.svg" alt="Maman portant son bébé pendant une visio" class="row-start-2 col-start-3" :style="styleMamaRight"/>
        <img src="../assets/img/hero-illu/Josepha.svg" alt="Josépha Raphard" class="col-start-2 row-span-2 self-center scale-110 translate-y-8" :style="styleJosepha"/>
      </div>
    </main>
  </div>
</template>
