  ...
  <Disclosure as="nav" class="bg-white shadow" v-slot="{ open }">
      ...
      <div class="flex justify-between h-16">
        ...
        <div class="flex items-center space-x-4">
          <div class="hidden flex-shrink-0 md:block">
            <router-link v-if="isAuth" to="/profil">Mon profil</router-link>
    ...
    <DisclosurePanel class="md:hidden">
      ...
      <div class="pt-4 pb-3 border-t border-gray-200">
        <div class="space-y-1">
          <a href="#" class="block px-4 py-2 text-base font-medium text-gray-700 hover:text-gray-700 hover:bg-gray-100 sm:px-6" @click.prevent="openLogin = true">Se connecter</a>
        </div>
      </div>
    </DisclosurePanel>
  </Disclosure>
